...
message = tk.Label(window, text="Attendance-Management-System" ,bg="black"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold')) 
...
txt2 = tk.Entry(window,textvariable = name_var,width=20  ,bg="white"  ,fg="black",font=('times', 15, ' bold ')  )
...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="black",activeforeground = "green",width=60  ,height=10  ,font=('times', 15, ' bold ')) 
...
def TakeImages():        
    ...
    name=(name_var.get())
    tmp=name.replace(" ","")
    if(is_number(Id) and tmp.isalpha()):
...
copyWrite.insert("insert", "Developed by Hrutik Chaudhari","", "", "superscript")
copyWrite.configure(state="disabled",fg="black"  )
copyWrite.pack(side="left")
copyWrite.place(x=600, y=950)
